...
var iframe_id = '#cadenadevalor'

$(document).ready(function(){
$(iframe_id, window.parent.document).prop('scrolling', 'no');
ajusta_altura();
})
...
let altura = $(document.body).height()+31;
console.log(altura);
$(iframe_id, window.parent.document).height(altura);
}
